...
async function createTelemetry(options, context) {
  const debugEnabled = options.telemetry?.debug || getBooleanEnvVar("BETTER_AUTH_TELEMETRY_DEBUG");
  const disableNotice = options.telemetry?.disableNotice || getBooleanEnvVar("BETTER_AUTH_TELEMETRY_DISABLE_NOTICE");
